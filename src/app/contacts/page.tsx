...
export const metadata: Metadata = {
  title: 'Контакты',
  description:
    'Свяжитесь с командой Моего Периметра — задайте вопрос, предложите тему или поделитесь обратной связью.',
  openGraph: {
    title: 'Контакты | Мой Периметр',
    description:
      'Свяжитесь с командой Моего Периметра — задайте вопрос, предложите тему или поделитесь обратной связью.',
    images: [{ url: '/images/og/og-default.png', width: 1200, height: 630, alt: 'Мой Периметр — Контакты' }],
  },
};
